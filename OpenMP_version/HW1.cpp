...
void displayCallback()
{
  ...
  //glutSwapBuffers();
    ...
    std::string s = "      FPS: " + particleSystem->fpsf();
    ...
    s = "  Min FPS: " + particleSystem->lowfpsf();
    ...
    s = "  Max FPS: " + particleSystem->peakfpsf();
    ...
    s =" Avg. FPS: " + particleSystem->avgfpsf();
    ...
    s ="Particles: " + particleSystem->particlesf();
...
int main(int argc, char** argv)
{
  ...
  glutInit(&argc, argv);
  glvu.Init(title, GLUT_DOUBLE | GLUT_RGBA | GLUT_DEPTH, 0, 0, 1680, 980);
